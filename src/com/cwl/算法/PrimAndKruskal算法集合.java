 ...
 * @Author: 陈文龙
 * @Description;
 * @Date: created in 22:27 2020-05-09
 * @ClassName: PrimAndKruskal算法集合
 * @Description TODO
 * @Author:
 * @Date: 2020-05-09 22:27
 * @Version" 1.0
 * <p>
...
public class PrimAndKruskal算法集合
{
     ...
     *     matrix-- 矩阵(数据)
     */
    public PrimAndKruskal算法集合(char[] vexs, int[][] matrix)
    {
    ...
    public static void main(String[] args)
    {
        ...
        PrimAndKruskal算法集合 pG;

        // 自定义"图"(输入矩阵队列)
        //pG = new 迪杰斯塔拉算法();
        // 采用已有的"图"
        pG = new PrimAndKruskal算法集合(vexs, matrix);
