 ...
 * @Author: 陈文龙
 * @Description;
 * @Date: created in 20:57 2020-05-09
 * @ClassName: Prim算法demo
 * @Description TODO
 * @Author:
 * @Date: 2020-05-09 20:57
 * @Version" 1.0
 * <p>
...
public class MatrixUDG
{
    ...
    public void prim(int start)
    {
        ...
        prims[index++] = mVexs[start]; /* 开始增长了，此时还是只有一个根节点的小树 */
        ...
        for (int i = 1; i < index; i++)
        {
            ...
            System.out.println(vexs[left] +"-" +vexs[right] + "   :"+min);
            sum += min;
        }
   ...
   static char[] vexs = {'A', 'B', 'C', 'D', 'E', 'F', 'G'};
    ...
    {
        /*
        节点到自己是0，不可达到就是Integer.MAX_VALUE;
         */
